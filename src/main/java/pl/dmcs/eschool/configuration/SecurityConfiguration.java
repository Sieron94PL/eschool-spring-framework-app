...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/teacher/**").access("hasRole('ROLE_TEACHER')").antMatchers("/student/**")
				.access("hasRole('ROLE_STUDENT')").antMatchers("/admin/**").access("hasRole('ROLE_ADMIN')").and()
